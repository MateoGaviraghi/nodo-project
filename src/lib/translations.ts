...
export const translations = {
  es: {
    ...
    contact: {
      ...
      video_desc: "Agendá 30 minutos gratis para hablar en detalle de tu proyecto.",
      video_cta: "Agendar llamada",
      form_card_desc: "Contanos tu idea en detalle. Te respondemos en menos de 24hs.",
      form_card_cta: "Ir al formulario",
      form_eyebrow: "Formulario",
      form_title: "Tu proyecto empieza acá.",
      form_subtitle: "Campos con * son requeridos.",
      form_project_placeholder: "Contanos sobre tu proyecto, qué necesitás y cualquier detalle relevante...",
      form_success_title: "¡Mensaje enviado!",
      form_success_text: "Te respondemos en menos de 24hs. Mientras tanto, podés escribirnos directamente por WhatsApp.",
      form_success_wa: "Ir a WhatsApp",
      form_error: "Hubo un error al enviar. Intentá de nuevo o escribinos por WhatsApp.",
      form_sending: "Enviando...",
      form_response_time: "Respondemos en menos de 24hs.",
  ...
  en: {
    ...
    contact: {
      ...
      wa_cta: "Write now",
      video_desc: "Schedule 30 free minutes to discuss your project in detail.",
      video_cta: "Schedule call",
      form_card_desc: "Tell us your idea in detail. We respond within 24h.",
      form_card_cta: "Go to form",
      form_eyebrow: "Form",
      form_title: "Your project starts here.",
      form_subtitle: "Fields marked with * are required.",
      form_project_placeholder: "Tell us about your project, what you need and any relevant details...",
      form_success_title: "Message sent!",
      form_success_text: "We'll get back to you within 24h. In the meantime, feel free to reach us on WhatsApp.",
      form_success_wa: "Go to WhatsApp",
      form_error: "Something went wrong. Try again or message us on WhatsApp.",
      form_sending: "Sending...",
      form_response_time: "We respond within 24h.",
